...
class S2PointTests: XCTestCase {
    ...
    func testOriginPoint() {
        ...
        // passes through.)
        let quadraticUV = S2Projection.quadratic.stToUV(2 / 3)
    ...
    func testPointCrossProduct() {
        ...
        let tests = [Test(p1: p000, p2: p000, normal: 1),
    ...
    func testDistance() {
        ...
        let tests = [Test(p1: p000, p2: p000, distance: 0),
                     Test(p1: p000, p2: p090, distance: .pi / 2),
                     Test(p1: p000, p2: S2Point(x: 0, y: 1, z: 1), distance: .pi / 2),
                     Test(p1: p000, p2: p180, distance: .pi),
                     Test(p1: S2Point(x: 1, y: 2, z: 3), p2: S2Point(x: 2, y: 3, z: -1), distance: 1.2055891055045298)]
    ...
    func testAlmostEqual() {
        ...
        let tests = [Test(p1: p000, p2: p000, expected: true),
    ...
    func testArea() {
        ...
        var tests = [Test(a: p000, b: p090, c: pz, expected: .pi / 2, nearness: 0),
        ...
        tests.append(contentsOf: [Test(a: pr, b: pr, c: pr, expected: 0, nearness: 0),
    ...
    func testPlanarCentroid() {
        ...
        let tests = [Test(name: "xyz axis", p0: S2Point(x: 0, y: 0, z: 1), p1: S2Point(x: 0, y: 1, z: 0),
