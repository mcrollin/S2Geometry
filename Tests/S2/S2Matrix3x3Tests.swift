...
class S2Matrix3x3Tests: XCTestCase {
    ...
    func testColumn() {
        ...
        let tests = [Test(matrix: S2Matrix3x3(), column: 0, expected: S2Point.coordinates(x: 0, y: 0, z: 0)),
    ...
    func testRow() {
        ...
        let matrix = S2Matrix3x3([1, 2, 3, 4, 5, 6, 7, 8, 9])
        let tests = [Test(matrix: S2Matrix3x3(), row: 0, expected: .origin),
    ...
    func testSetColumn() {
        ...
        let tests = [Test(matrix: S2Matrix3x3(), column: 0, point: S2Point(x: 1, y: 1, z: 0),
    ...
    func testSetRow() {
        ...
        let tests = [Test(matrix: S2Matrix3x3(), row: 0, point: S2Point(x: 1, y: 1, z: 0),
    ...
    func testScale() {
        ...
        let tests = [Test(matrix: S2Matrix3x3(), scale: 0, expected: S2Matrix3x3()),
    ...
    func testMultiply() {
        ...
        let tests = [Test(matrix: S2Matrix3x3([Double](repeating: 1, count: 9)),
    ...
    func testDeterminant() {
        ...
        let tests = [Test(matrix: S2Matrix3x3(), expected: 0),
    ...
    func testTransposed() {
        ...
        let tests = [Test(matrix: S2Matrix3x3(), expected: S2Matrix3x3()),
                     Test(matrix: S2Matrix3x3([1, 2, 3, 4, 5, 6, 7, 8, 9]),
    ...
    func testFrame() {
        ...
        let tests = [Test(a: frame.column(2), b: point),
